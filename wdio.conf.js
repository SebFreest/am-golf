...
exports.config = {
    ...
    onComplete: function() {
        ...
        const generation = allure(['generate', 'artifacts/allure-results', '--clean', '--output', 'artifacts/allure-report']);
    ...
    cucumberOpts: {
        ...
        timeout: 60000 * timeoutsModifier,     // <number> timeout for step definitions
